...
class DATABASE_CONFIG {
	...
	var $dev = array(
		...
		'persistent' => false,
		'host' => 'localhost',
		'login' => 'digitaltlandkort',
		'password' => 'digitaltlandkort',
		'database' => 'digitaltlandkort',
		'prefix' => ''
	);
	...
	public $test_suite = array(
		...
		'login' => 'digitaltlandkort',
		'password' => 'digitaltlandkort',
		'database' => 'digitaltlandkort_test'
	);
		
	function __construct () {
		//$this->default = (env('SERVER_NAME') == 'e2012.dev') ? $this->dev : $this->production;
